...
const FormSchema = Yup.object({
    absentee: Yup.number().typeError("Invalid").min(0, "Invalid").required("Required"),
    ...
    finalExam: Yup.number().typeError("Invalid").min(0, "Invalid").max(100, "Invalid").required("Required"),
    midtermExam: Yup.number().typeError("Invalid").min(0, "Invalid").max(100, "Invalid").required("Required"),
