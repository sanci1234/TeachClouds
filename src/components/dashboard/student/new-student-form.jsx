...
const NewStudentForm = ({ advisorTeachers }) => {
  const [state, dispatch] = useFormState(createStudentAction, initialResponse);
  return (
            ...
            <div className="row row-cols-1 row-cols-md-2 row-cols-xl-3">
              <div className="col">
                <div className="form-floating mb-3">
                  <input
                    type="text"
                    className={`form-control ${isInvalid(state.errors?.name)}`}
                    id="name"
                    name="name"
              ...
              <div className="col">
                <div className="form-floating mb-3">
                  <input
                    type="text"
                    className={`form-control ${isInvalid(state.errors?.email)}`}
                    id="email"
                    name="email"
                    placeholder="Email"
                  />
